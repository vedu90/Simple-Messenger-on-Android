        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            try
            {
                while(true)
                {
                    ...
                    if(message == null)
                    {
                        Log.e(TAG,"Null message on Server Side");
						continue;
                    }
                    ...
                    if(responseMsg != null)
                    {
                        Log.e(TAG, "Response message sent");
                        responseMsg.writeBytes("OK");
                    }

                    Log.e(TAG,"Checking Server side 2");
                    publishProgress(message);
                    Log.e(TAG,"Checking Server side");
                    clientSocket.close();
                }
            }
            catch (Exception e) {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                while(t<maxAttempts)
                {
                    ...
                    while(i<time_limit)
                    {
                        Log.e(TAG, "Waiting for response message from server");
                    ...
                    if(sendStatus == true)
                    {
                        Log.e(TAG,"Successfully sent to Server");
                        break;
                    }
                    t+=1;
                }
                Log.e(TAG,"Checking client side");

                Log.e(TAG,"Checking client side 2");
                outputMsg.close();
                socket.close();
